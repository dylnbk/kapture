  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Kapture specific colors - Dark mode
        'dark-base': '#121212',
        ...
        'dark-error': '#E70063',
        'dark-border': '#878787',
        // Kapture specific colors - Light mode
        'light-base': '#F2F0EF',
        'light-text-primary': '#2C2C2C',
        'light-text-secondary': '#5F5F5F',
        'light-accent': '#000000',
        'light-success': '#00EB9B',
        'light-error': '#E70063',
        'light-border': '#878787',
      },
      borderRadius: {
      ...
      backgroundImage: {
        ...
        'gradient-glassmorphism-dark': 'linear-gradient(135deg, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.05))',
      },
    },
  },
